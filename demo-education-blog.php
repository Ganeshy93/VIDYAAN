									...
									<div class="header-row">
										<ul class="list list-unstyled list-inline mb-0">
											<li class="list-inline-item mb-0">
												...
												<a href="page-login.php" class="text-color-secondary text-color-hover-primary font-weight-semibold text-decoration-none text-2">
													Login / Register
												</a>
											</li>
										</ul>
										...
										<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li>
														<a href="demo-education.php" class="nav-link">Home</a>
													</li>
													<li>
														<a href="demo-education-about-us.php" class="nav-link">About Us</a>
													</li>
													<li>
														<a href="demo-education-courses.php" class="nav-link">Courses</a>
													</li>
													<li>
														<a href="demo-education-instructors.php" class="nav-link">Instructors</a>
													</li>
													<li>
														<a href="demo-education-blog.php" class="nav-link active">Blog</a>
													</li>
													<li>
														<a href="demo-education-contact-us.php" class="nav-link">Contact Us</a>
													</li>
												</ul>
											</nav>
										</div>
					...
					<div class="row py-3">
							...
							<article class="mb-5">
								<div class="card bg-transparent border-0 custom-border-radius-1">
									<div class="card-body p-0 z-index-1">
										<a href="demo-education-blog-post.php" data-cursor-effect-hover="plus">
										...
										<div class="card-body p-0">
											<h4 class="card-title text-5 font-weight-semi-bold pb-1 mb-2"><a class="text-color-secondary text-color-hover-primary text-decoration-none text-4" href="demo-education-blog-post.php">The Education Business</a></h4>
											...
											<a href="demo-education-blog-post.php" class="text-decoration-none custom-link-hover-effects">
							...
							<article class="mb-5">
								<div class="card bg-transparent border-0 custom-border-radius-1">
									<div class="card-body p-0 z-index-1">
										...
										<div class="card-body p-0">
											<h4 class="card-title text-5 font-weight-semi-bold pb-1 mb-2"><a class="text-color-secondary text-color-hover-primary text-decoration-none text-4" href="demo-education-blog-post.php">How to Grow your Business</a></h4>
											<p class="card-text mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lorem , consectetur adipiscing elit...</p>
											<a href="demo-education-blog-post.php" class="text-decoration-none custom-link-hover-effects">
												<span class="btn btn-link font-weight-semi-bold text-decoration-none text-2 ps-0 text-uppercase">
													Read More
						...
						<div class="blog-sidebar col-lg-4 pt-4 pt-lg-0 mb-5">
							<aside class="sidebar">
								...
								<div class="px-3 mt-4">
									<form action="page-search-results.php" method="get">
								...
								<div class="px-3 mt-4">
									...
									<div class="pb-2 mb-1">
										<a href="#" class="text-color-default text-2 mb-0 d-block text-decoration-none line-height-4">Admin on <strong class="text-color-secondary text-hover-primary text-4">Vivamus sollicitudin</strong> <span class="text-uppercase text-1 d-block pt-1 pb-3">10 Jan 2023</span></a>
										<a href="#" class="text-color-default text-2 mb-0 d-block text-decoration-none line-height-4">John Doe on <strong class="text-color-secondary text-hover-primary text-4">Lorem ipsum dolor</strong> <span class="text-uppercase text-1 d-block pt-1 pb-3">10 Jan 2023</span></a>
										<a href="#" class="text-color-default text-2 mb-0 d-block text-decoration-none line-height-4">Admin on <strong class="text-color-secondary text-hover-primary text-4">Consectetur adipiscing</strong> <span class="text-uppercase text-1 d-block pt-1 pb-3">10 Jan 2023</span></a>
									</div>
								</div>
								<div class="py-1 clearfix">
									<hr class="my-2">
				...
				<div class="container py-5">
					<div class="row py-5">
						<div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
							...
							<a href="demo-education.php" class="d-inline-block mb-3">
						...
						<div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
							...
							<ul class="list list-unstyled opacity-6">
								<li class="mb-1">
									<a href="demo-education.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Home</a>
								</li>
								<li class="mb-1">
									<a href="demo-education-about-us.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- About Us</a>
								</li>
								<li class="mb-1">
									<a href="demo-education-courses.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Courses</a>
								</li>
								<li class="mb-1">
									<a href="demo-education-instructors.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Instructors</a>
								</li>
								<li class="mb-1">
									<a href="demo-education-blog.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Blog</a>
								</li>
								<li>
									<a href="demo-education-contact-us.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Contact Us</a>
								</li>
							</ul>
						</div>
						<div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
							...
							<ul class="list list-unstyled opacity-6">
								<li class="mb-1">
									<a href="demo-education.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Documentation</a>
								</li>
								<li class="mb-1">
									<a href="demo-education.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Forums</a>
								</li>
								<li class="mb-1">
									<a href="demo-education.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Open a Ticket</a>
								</li>
								<li>
									<a href="demo-education.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- FAQ's</a>
								</li>
							</ul>
						</div>
						<div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
							...
							<ul class="list list-unstyled opacity-6">
								<li class="mb-1">
									<a href="demo-education.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Terms of Use</a>
								</li>
								<li>
									<a href="demo-education.php" class="text-decoration-none text-color-tertiary text-color-hover-primary link-hover-style-1">- Privacy Policy</a>
								</li>
							</ul>
						</div>
					</div>
