										...
										<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li>
														<a href="demo-education-courses.php" class="nav-link active">Courses</a>
													</li>
													<li>
														<a href="demo-education-instructors.php" class="nav-link">Instructors</a>
													</li>
													<li>
														<a href="demo-education-blog.php" class="nav-link">Blog</a>
													</li>
													<li>
										...
										<div class="ps-md-0 mb-3 mb-md-0 pe-4 border-right">
											<div class="d-flex align-items-center">
												<div class="img-thumbnail img-thumbnail-no-borders">
													<img src="img/avatars/avatar.jpg" class="custom-course-detail-avatar" alt="">
												</div>
												<div class="ps-3">
													<p class="mb-0 text-1 text-uppercase p-relative top-3">Instructor</p>
													<h4 class="mb-0 text-color-secondary text-4"><a href="demo-education-courses-details.php" class="text-color-secondary" title="">John Doe</a></h4>
												</div>
											</div>
										</div>
										<div class="ps-md-4 mb-3 mb-md-0 flex-grow-1">
											<div class="d-flex flex-row align-items-center h-100">
												<div class="p-0">
													...
													<h4 class="mb-0 text-color-secondary text-4"><a href="demo-education-courses-details.php" class="text-color-secondary" title="">Web Development</a></h4>
												</div>
											</div>
										</div>
										...
										<div class="col-md-4 mb-4 pb-1">
											<div class="card custom-card-courses border-radius-0 hover-effect-1">
												<div class="p-relative">
													<a href="demo-education-courses-details.php" class="text-color-secondary" title="">
												...
												<div class="card-body">
													...
													<h4 class="mb-3 text-color-secondary"><a href="demo-education-courses-details.php" class="text-color-secondary" title="">Course Name Example</a></h4>
								...
								<div class="mt-2 mb-4 pb-2">
									...
									<ul class="simple-post-list">
										<li class="border-0">
											...
											<div class="post-info">
												<a href="blog-post.php" class="text-color-secondary text-3 font-weight-semi-bold line-height-4 d-block pb-1">Course Name Example</a>
												<div class="post-meta">
										...
										<div class="container p-relative py-3">
											...
											<div class="custom-element custom-element-pos-4 appear-animation" data-appear-animation="expandIn" data-appear-animation-delay="200">
												<div class="opacity-2" data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.8, 'transition': true, 'transitionDuration': 3000}">
													<img class="icon-animated" width="157" height="157" src="img/demos/education/elements/element-1.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" />
												</div>
											</div>
											...
											<div class="row align-items-center justify-content-center text-center">
												<div class="col col pt-2">
													...
													<a href="demo-education-courses.php" class="btn btn-secondary font-weight-bold btn-px-5 btn-py-3 mt-4 mb-2 appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="350">GET STARTED NOW</a>
												</div>
											</div>
										</div>
									</section>
